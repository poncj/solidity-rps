...
contract RockPaperScissors {    
    ...
    event GamePlayed(address indexed player, uint8 gameResult, string details, uint256 betAmount, uint256 winAmount);
    ...
    function playGame(uint8 _optionByPlayer) internal returns(uint256 amount) {
        ...
        if (target[_optionByPlayer] == _optionByContract) {
            ...
            emit GamePlayed(msg.sender, uint8(gameResult.Win), details, msg.value, msg.value*2);
            ...
            emit GamePlayed(msg.sender, uint8(gameResult.Draw), details, msg.value, msg.value);
        ...
        emit GamePlayed(msg.sender, uint8(gameResult.Loss), details, msg.value, 0);
